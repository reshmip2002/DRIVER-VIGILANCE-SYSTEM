...
public class send_feedback extends AppCompatActivity {
  EditText s,n;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s=findViewById(R.id.editTextTextMultiLine);
        ...
        c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String feedback =s.getText().toString();


                sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                sh.getString("ip","");
                sh.getString("url","");
                url=sh.getString("url","")+"/send_feedback";
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        Toast.makeText(send_feedback.this, "Feedback Send", Toast.LENGTH_SHORT).show();
